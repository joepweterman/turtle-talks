...
function buildArgs(wavPath, lang, baseDir, opts) {
  ...
  // the encoder is the whole cost and scales with threads: on an 8-core machine
  // all 8 is ~35% faster than 4 under sustained load. Callers that need to leave
  // room for a running video call pass a lower count.
