...
const DEFAULTS = {
  ...
  dictLang: 'auto',
  dictCleanup: false,        // polish dictations with a local LLM before pasting
  cleanupModel: '',          // '' = auto (small model if installed, else the summary model)
  ...
  corrections: [],           // learned {from, to} transcription fixes
  multiSpeaker: false,       // diarize the mic track (several people in the room)
};
